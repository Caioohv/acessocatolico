import __nuxt_component_1$1 from './index-B4nyd6v-.mjs';
import { _ as _sfc_main$3 } from './NuxtImg-JsLvlz-l.mjs';
import { defineComponent, ref, computed, resolveComponent, unref, withCtx, createVNode, createTextVNode, mergeProps, isRef, createBlock, createCommentVNode, toDisplayString, openBlock, useSlots, toRef, renderSlot, toHandlers, inject, provide, useSSRContext } from 'vue';
import { ssrRenderAttrs, ssrRenderComponent, ssrInterpolate, ssrRenderAttr, ssrRenderList, ssrRenderSlot, ssrRenderClass } from 'vue/server-renderer';
...
import { a as _sfc_main$4, t as tv } from './Button-HUtl9tHz.mjs';
import { c as useRoute, _ as _export_sfc, a as useAppConfig } from './server.mjs';
                                    ...
                                    if (_push5) {
                                      ...
                                      return [
                                        renderSlot(_ctx.$slots, "close", { ui: ui.value }, () => {
                                          var _a4;
                                          return [
                                            __props.close ? (openBlock(), createBlock(_sfc_main$4, mergeProps({
                                              key: 0,
                                              icon: __props.closeIcon || unref(appConfig).ui.icons.close,
                                              size: "md",
                                              color: "neutral",
...
//# sourceMappingURL=_id_-pL5McxWE.mjs.map
