  ...
  <div class="container mx-auto px-4 py-8">
    ...
    <div class="mb-8">
      <nav class="flex items-center space-x-2 text-sm mb-4">
        ...
        <span class="text-gray-500">Criar evento</span>
      </nav>
      
      <h1 class="text-3xl font-bold text-gray-900">Criar novo evento</h1>
      <p class="text-gray-600 mt-2">Preencha as informações para criar seu evento católico</p>
    </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <p class="text-sm text-gray-500 mt-1">
              Rascunhos não ficam visíveis publicamente
            </p>
          </div>
        </div>
...
// Meta tags
useSeoMeta({
  title: 'Criar Evento - Acesso Católico',
  description: 'Crie um novo evento católico na plataforma Acesso Católico',
...
// Composables
const { user } = useAuth()
const { createEvent, generateSlug } = useEvents()
...
onMounted(() => {
  ...
  form.value.registrationStart = now.toISOString().slice(0, 16)
